...
\input{tables_r1/table_secdist_comparison}
...
\input{tables_r1/table_notation}
...
\input{tables_r1/table_adjoint_validation}
...
\input{tables_r1/table_dc_ac_radii}
...
\input{tables_r1/table_zero_flow}
...
\input{tables_r1/table_sigma_calibration}
...
\input{tables_r1/table_replay_multiscale}

\paragraph{Ranking quality with scenario-level uncertainty}
Table~\ref{tab:ranking} repeats the 118-bus ranking study with 10{,}000
converged nonlinear scenarios and scenario-bootstrap intervals.  The

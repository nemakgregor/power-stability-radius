...
The worst-case verification experiments (`experiments/run_worst_case_verify.py`)
...
analysis**. The research question (addressed by `experiments/run_pglib_sweep.py`)
...
and `experiments/run_worst_case_verify.py`.
...
**Implemented in:** `src/stability_radius/metrics_analysis.py`.
...
**Implemented in:** `src/stability_radius/metrics_analysis.py`, function
